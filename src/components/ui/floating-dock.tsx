        ...
        <div className={cn("relative block md:hidden", className)}>
            ...
            >
                <svg
                    ...
                    className="text-neutral-500 dark:text-neutral-400 h-5 w-5"
                >
...
function IconContainer({
    ...
    return (
        <motion.div
            ...
            className="aspect-square rounded bg-gray-200 dark:bg-neutral-800 flex items-center justify-center relative"
        >
            <AnimatePresence>
                {hovered && (
                    <motion.div
